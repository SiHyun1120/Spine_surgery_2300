...
int rst_btn = 4; // 사용자의 무게중심에 맞게 초기화할 용도의 버튼
...
// -------------------------------------------------
      ...
      btSerial.write(150); 
      btSerial.write(standard_x + 50);
      btSerial.write(standard_y + 50);
      btSerial.write(xbar_0 + 50);
      btSerial.write(ybar_0 + 50);
      btSerial.write(xbar + 50);
      btSerial.write(ybar + 50);
